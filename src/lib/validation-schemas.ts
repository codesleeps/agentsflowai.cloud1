...
const LeadStatusEnum = z.enum(['new', 'contacted', 'qualified', 'proposal', 'closed_won', 'closed_lost']);
const LeadBudgetEnum = z.enum(['under_5k', '5k_25k', '25k_100k', '100k_500k', '500k_plus']);
const LeadTimelineEnum = z.enum(['immediate', '1_3_months', '3_6_months', '6_12_months', '12_plus_months']);
...
export const LeadCreateSchema = z.object({
  ...
  company: z.string().optional().max(100, 'Company name must be less than 100 characters'),
